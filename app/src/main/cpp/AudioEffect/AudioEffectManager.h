...
public:
    ...
    void init(int sampleRate) {
        ...
        qualityEffects_.push_back(std::make_unique<StereoWidener>());
        qualityEffects_.push_back(std::make_unique<VirtualBass>());
        qualityEffects_.push_back(std::make_unique<MultibandCompressor>());
